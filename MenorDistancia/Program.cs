...
class HelloWorld
{
    static void Main()
    {
        ...
        Console.WriteLine($"Os números são:  {menorDistanciaInfo.Numeroarr1} do array 1 e {menorDistanciaInfo.Numeroarr2} do array 2. Sendo a menor distancia: {menorDistanciaInfo.Distancia}");
